...
export const WithIcons = () => (
  <>
    <Button
      ...
      disabled={boolean('disabled', false)}
      endIcon={
        <svg xmlns='http://www.w3.org/2000/svg' width='16' viewBox='0 0 10 10'>
          <path
            style={{ fill: 'currentColor' }}
            d='M5 10c-.1 0-.3 0-.4-.1-.2-.2-.2-.5 0-.7l3.6-3.6H.4c-.3 0-.5-.2-.5-.5s.2-.5.5-.5h7.8L4.6 1c-.2-.2-.2-.5 0-.7.2-.2.5-.2.7 0l4.5 4.5.1.1v.4c0 .1-.1.1-.1.1L5.3 9.9s-.2.1-.3.1z'
          />
        </svg>
    ...
    <Button
      ...
      startIcon={
        <>
          <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8.1 8.1' width='16' style={{ fill: 'currentColor' }}>
    ...
    <Button
      ...
      startIcon={
        <>
          <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 13.1 12.8' width='16' fill='currentColor'>
